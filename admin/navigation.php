        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts_dropdown" class="collapse">
                    ...
                    <li>
                        <a href="post.php?src=add_post">Add post</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <!-- <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-dashboard"></i> Dropdown <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-dashboard"></i>
                ...
                <ul id="demo" class="collapse">
                    ...
                    <li>
                        <a href="user.php?src=add_user">Add user</a>
                    </li>
                </ul>
            </li>
